...
def get_train_test(MAX_LENGTH, MAX_ARGUMENT_SEQUENCE_LENGTH, data, lab2id, fid2id):
    ...
    # form data 
    try :
        train_df = train_df.loc[:, ['sentence', 'predicate', 'directed_graph_matrix', 'span_answers', 'num_of_tokens', 'args', 'fid_candidates', 'frameID']]
        valid_df = valid_df.loc[:, ['sentence', 'predicate', 'directed_graph_matrix', 'span_answers', 'num_of_tokens', 'args', 'fid_candidates', 'frameID']]
    except:
        train_df = train_df.loc[:, ['sentence', 'predicate', 'span_answers', 'num_of_tokens','args', 'fid_candidates', 'frameID']]
        test_df = test_df.loc[:, ['sentence', 'predicate', 'span_answers', 'num_of_tokens', 'args', 'fid_candidates', 'frameID']]
        valid_df = valid_df.loc[:, ['sentence', 'predicate', 'span_answers', 'num_of_tokens', 'args', 'fid_candidates', 'frameID']]
